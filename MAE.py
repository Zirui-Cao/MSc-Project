...
# test_ds = test_ds.batch(10000).prefetch(AUTO)
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch == 196:
            ...
            for i in range(test_patches.shape[0]):
                ...
                address = "./Result/pitch_4/" + str(i + 1) + ".jpg"
                plt.savefig(address)
...
# 模型编译与训练！！！！！！！！！！！！！！！Model compile and train
